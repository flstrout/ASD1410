...
//Rare exceptions to indicate a bug in the _stroutfred_asd1410_sqlite code (Eg, function that a subclass should have implemented)
...
/**
 The base class for StroutFred_ASD1410_SQLite proxies.
 */
