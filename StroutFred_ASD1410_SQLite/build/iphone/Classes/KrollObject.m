...
//@interface StroutFred_ASD1410_SQLiteObject : NSObject
//@end

@interface StroutFred_ASD1410_SQLiteObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StroutFred_ASD1410_SQLiteObject class]])
		{
			for (NSString *key in [[(StroutFred_ASD1410_SQLiteObject*)o modules] allKeys])
			{
