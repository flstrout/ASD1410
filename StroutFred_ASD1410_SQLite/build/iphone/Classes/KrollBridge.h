...
@interface StroutFred_ASD1410_SQLiteObject : KrollCoverageObject {
#else
@interface StroutFred_ASD1410_SQLiteObject : KrollObject {
#endif
@private
...
extern NSString * StroutFred_ASD1410_SQLite$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	StroutFred_ASD1410_SQLiteObject *_stroutfred_asd1410_sqlite;
    KrollObject* console;
	BOOL shutdown;
