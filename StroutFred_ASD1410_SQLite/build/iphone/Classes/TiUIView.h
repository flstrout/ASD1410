...
/**
 Base class for all StroutFred_ASD1410_SQLite views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the StroutFred_ASD1410_SQLite view hierarchy (such as wrapped iOS UIViews) was touched.
