...
// in simulator we redefine to format for StroutFred_ASD1410_SQLite Developer console
...
{\
	NSString * exceptionName = [@"org.stroutfred_asd1410_sqlite." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stroutfred_asd1410_sqlite";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIStroutFred_ASD1410_SQLiteNativeItemNone = -1, 
	UIStroutFred_ASD1410_SQLiteNativeItemSpinner = -2,
	UIStroutFred_ASD1410_SQLiteNativeItemProgressBar = -3,
	
	UIStroutFred_ASD1410_SQLiteNativeItemSlider = -4,
	UIStroutFred_ASD1410_SQLiteNativeItemSwitch = -5,
	UIStroutFred_ASD1410_SQLiteNativeItemMultiButton = -6,
	UIStroutFred_ASD1410_SQLiteNativeItemSegmented = -7,
	
	UIStroutFred_ASD1410_SQLiteNativeItemTextView = -8,
	UIStroutFred_ASD1410_SQLiteNativeItemTextField = -9,
	UIStroutFred_ASD1410_SQLiteNativeItemSearchBar = -10,
	
	UIStroutFred_ASD1410_SQLiteNativeItemPicker = -11,
	UIStroutFred_ASD1410_SQLiteNativeItemDatePicker = -12,
	
	UIStroutFred_ASD1410_SQLiteNativeItemInfoLight = -13,
	UIStroutFred_ASD1410_SQLiteNativeItemInfoDark = -14,
	
	UIStroutFred_ASD1410_SQLiteNativeItemDisclosure = -15,
	
	UIStroutFred_ASD1410_SQLiteNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all StroutFred_ASD1410_SQLite instances of
