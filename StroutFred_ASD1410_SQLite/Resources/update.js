...
var id = getDetail.rowID;
var today = getDetail.dataDate.text;
var manager = Ti.App.Properties.getString("name");
var store = Ti.App.Properties.getString("store");
var customer = getDetail.dataCustomer.text;
var problem = getDetail.dataOpportunity.text;
var promise = getDetail.dataPromise.text;
