...
// in simulator we redefine to format for StroutFred_PMA3_1410_Objects Developer console
...
{\
	NSString * exceptionName = [@"org.stroutfred_pma3_1410_objects." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stroutfred_pma3_1410_objects";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIStroutFred_PMA3_1410_ObjectsNativeItemNone = -1, 
	UIStroutFred_PMA3_1410_ObjectsNativeItemSpinner = -2,
	UIStroutFred_PMA3_1410_ObjectsNativeItemProgressBar = -3,
	
	UIStroutFred_PMA3_1410_ObjectsNativeItemSlider = -4,
	UIStroutFred_PMA3_1410_ObjectsNativeItemSwitch = -5,
	UIStroutFred_PMA3_1410_ObjectsNativeItemMultiButton = -6,
	UIStroutFred_PMA3_1410_ObjectsNativeItemSegmented = -7,
	
	UIStroutFred_PMA3_1410_ObjectsNativeItemTextView = -8,
	UIStroutFred_PMA3_1410_ObjectsNativeItemTextField = -9,
	UIStroutFred_PMA3_1410_ObjectsNativeItemSearchBar = -10,
	
	UIStroutFred_PMA3_1410_ObjectsNativeItemPicker = -11,
	UIStroutFred_PMA3_1410_ObjectsNativeItemDatePicker = -12,
	
	UIStroutFred_PMA3_1410_ObjectsNativeItemInfoLight = -13,
	UIStroutFred_PMA3_1410_ObjectsNativeItemInfoDark = -14,
	
	UIStroutFred_PMA3_1410_ObjectsNativeItemDisclosure = -15,
	
	UIStroutFred_PMA3_1410_ObjectsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all StroutFred_PMA3_1410_Objects instances of
