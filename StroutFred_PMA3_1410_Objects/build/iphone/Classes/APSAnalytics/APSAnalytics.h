 ...
 * to send analytic data that can be viewed on the StroutFred_PMA3_1410_Objects Dashboard.
 *
 * For information on getting started with StroutFred_PMA3_1410_Objects Platform Services,
