...
//@interface StroutFred_PMA3_1410_ObjectsObject : NSObject
//@end

@interface StroutFred_PMA3_1410_ObjectsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StroutFred_PMA3_1410_ObjectsObject class]])
		{
			for (NSString *key in [[(StroutFred_PMA3_1410_ObjectsObject*)o modules] allKeys])
			{
