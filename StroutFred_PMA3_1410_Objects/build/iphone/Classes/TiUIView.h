...
/**
 Base class for all StroutFred_PMA3_1410_Objects views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the StroutFred_PMA3_1410_Objects view hierarchy (such as wrapped iOS UIViews) was touched.
