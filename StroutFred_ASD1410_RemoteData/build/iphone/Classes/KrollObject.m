...
//@interface StroutFred_ASD1410_RemoteDataObject : NSObject
//@end

@interface StroutFred_ASD1410_RemoteDataObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StroutFred_ASD1410_RemoteDataObject class]])
		{
			for (NSString *key in [[(StroutFred_ASD1410_RemoteDataObject*)o modules] allKeys])
			{
