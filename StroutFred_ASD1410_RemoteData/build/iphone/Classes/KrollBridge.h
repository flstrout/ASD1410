...
@interface StroutFred_ASD1410_RemoteDataObject : KrollCoverageObject {
#else
@interface StroutFred_ASD1410_RemoteDataObject : KrollObject {
#endif
@private
...
extern NSString * StroutFred_ASD1410_RemoteData$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	StroutFred_ASD1410_RemoteDataObject *_stroutfred_asd1410_remotedata;
    KrollObject* console;
	BOOL shutdown;
