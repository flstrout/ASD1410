...
// in simulator we redefine to format for StroutFred_ASD1410_RemoteData Developer console
...
{\
	NSString * exceptionName = [@"org.stroutfred_asd1410_remotedata." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stroutfred_asd1410_remotedata";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIStroutFred_ASD1410_RemoteDataNativeItemNone = -1, 
	UIStroutFred_ASD1410_RemoteDataNativeItemSpinner = -2,
	UIStroutFred_ASD1410_RemoteDataNativeItemProgressBar = -3,
	
	UIStroutFred_ASD1410_RemoteDataNativeItemSlider = -4,
	UIStroutFred_ASD1410_RemoteDataNativeItemSwitch = -5,
	UIStroutFred_ASD1410_RemoteDataNativeItemMultiButton = -6,
	UIStroutFred_ASD1410_RemoteDataNativeItemSegmented = -7,
	
	UIStroutFred_ASD1410_RemoteDataNativeItemTextView = -8,
	UIStroutFred_ASD1410_RemoteDataNativeItemTextField = -9,
	UIStroutFred_ASD1410_RemoteDataNativeItemSearchBar = -10,
	
	UIStroutFred_ASD1410_RemoteDataNativeItemPicker = -11,
	UIStroutFred_ASD1410_RemoteDataNativeItemDatePicker = -12,
	
	UIStroutFred_ASD1410_RemoteDataNativeItemInfoLight = -13,
	UIStroutFred_ASD1410_RemoteDataNativeItemInfoDark = -14,
	
	UIStroutFred_ASD1410_RemoteDataNativeItemDisclosure = -15,
	
	UIStroutFred_ASD1410_RemoteDataNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all StroutFred_ASD1410_RemoteData instances of
