...
/**
 The base class for all StroutFred_ASD1410_RemoteData modules
 */
...
/**
 StroutFred_ASD1410_RemoteData Platform calls this method on startup.
 */
-(void)startup;

/**
 StroutFred_ASD1410_RemoteData Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 StroutFred_ASD1410_RemoteData Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 StroutFred_ASD1410_RemoteData Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 StroutFred_ASD1410_RemoteData Platform calls this method on resume.
 @param sender The sender of the event.
 */
