...
// in simulator we redefine to format for StroutFred_ASD1410_CCandOOP Developer console
...
{\
	NSString * exceptionName = [@"org.stroutfred_asd1410_ccandoop." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stroutfred_asd1410_ccandoop";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIStroutFred_ASD1410_CCandOOPNativeItemNone = -1, 
	UIStroutFred_ASD1410_CCandOOPNativeItemSpinner = -2,
	UIStroutFred_ASD1410_CCandOOPNativeItemProgressBar = -3,
	
	UIStroutFred_ASD1410_CCandOOPNativeItemSlider = -4,
	UIStroutFred_ASD1410_CCandOOPNativeItemSwitch = -5,
	UIStroutFred_ASD1410_CCandOOPNativeItemMultiButton = -6,
	UIStroutFred_ASD1410_CCandOOPNativeItemSegmented = -7,
	
	UIStroutFred_ASD1410_CCandOOPNativeItemTextView = -8,
	UIStroutFred_ASD1410_CCandOOPNativeItemTextField = -9,
	UIStroutFred_ASD1410_CCandOOPNativeItemSearchBar = -10,
	
	UIStroutFred_ASD1410_CCandOOPNativeItemPicker = -11,
	UIStroutFred_ASD1410_CCandOOPNativeItemDatePicker = -12,
	
	UIStroutFred_ASD1410_CCandOOPNativeItemInfoLight = -13,
	UIStroutFred_ASD1410_CCandOOPNativeItemInfoDark = -14,
	
	UIStroutFred_ASD1410_CCandOOPNativeItemDisclosure = -15,
	
	UIStroutFred_ASD1410_CCandOOPNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all StroutFred_ASD1410_CCandOOP instances of
