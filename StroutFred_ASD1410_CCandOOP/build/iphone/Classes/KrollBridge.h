...
@interface StroutFred_ASD1410_CCandOOPObject : KrollCoverageObject {
#else
@interface StroutFred_ASD1410_CCandOOPObject : KrollObject {
#endif
@private
...
extern NSString * StroutFred_ASD1410_CCandOOP$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	StroutFred_ASD1410_CCandOOPObject *_stroutfred_asd1410_ccandoop;
    KrollObject* console;
	BOOL shutdown;
