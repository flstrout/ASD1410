 ...
 * to send analytic data that can be viewed on the StroutFred_ASD1410_CCandOOP Dashboard.
 *
 * For information on getting started with StroutFred_ASD1410_CCandOOP Platform Services,
