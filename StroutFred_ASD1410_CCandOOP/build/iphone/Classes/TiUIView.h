...
/**
 Base class for all StroutFred_ASD1410_CCandOOP views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the StroutFred_ASD1410_CCandOOP view hierarchy (such as wrapped iOS UIViews) was touched.
