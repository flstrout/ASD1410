...
//@interface StroutFred_ASD1410_CCandOOPObject : NSObject
//@end

@interface StroutFred_ASD1410_CCandOOPObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StroutFred_ASD1410_CCandOOPObject class]])
		{
			for (NSString *key in [[(StroutFred_ASD1410_CCandOOPObject*)o modules] allKeys])
			{
